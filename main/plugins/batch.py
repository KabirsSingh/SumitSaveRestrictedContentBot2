#Tg:official_satyam01/official_satyam01
#Github.com/sumit10869
...
async def _batch(event):
    ...
    if event.sender_id in batch:
        return await event.reply("You've already started one batch, wait for it to complete please wait!")
